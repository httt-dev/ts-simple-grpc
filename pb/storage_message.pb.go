...
type Storage struct {
	...
	Driver Storage_Driver `protobuf:"varint,1,opt,name=driver,proto3,enum=httt.dev.pcbook.Storage_Driver" json:"driver,omitempty"`
...
var file_storage_message_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0f, 0x68, 0x74, 0x74, 0x74, 0x2e, 0x64, 0x65,
	0x76, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x1a, 0x14, 0x6d, 0x65, 0x6d, 0x6f, 0x72, 0x79,
	...
	0x69, 0x76, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1f, 0x2e, 0x68, 0x74, 0x74,
	0x74, 0x2e, 0x64, 0x65, 0x76, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x53, 0x74, 0x6f,
	...
	0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x68, 0x74, 0x74, 0x74, 0x2e, 0x64, 0x65, 0x76, 0x2e, 0x70,
	...
	0x44, 0x44, 0x10, 0x01, 0x12, 0x07, 0x0a, 0x03, 0x53, 0x53, 0x44, 0x10, 0x02, 0x42, 0x14, 0x5a,
...
var file_storage_message_proto_goTypes = []any{
	(Storage_Driver)(0), // 0: httt.dev.pcbook.Storage.Driver
	(*Storage)(nil),     // 1: httt.dev.pcbook.Storage
	(*Memory)(nil),      // 2: httt.dev.pcbook.Memory
}
var file_storage_message_proto_depIdxs = []int32{
	0, // 0: httt.dev.pcbook.Storage.driver:type_name -> httt.dev.pcbook.Storage.Driver
	2, // 1: httt.dev.pcbook.Storage.memory:type_name -> httt.dev.pcbook.Memory
